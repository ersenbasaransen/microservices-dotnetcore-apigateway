...
namespace Product.Microservice.Features.ProductFeatures.Queries.GetAllProducts
{
    public class GetAllProductsQuery : IRequest<IEnumerable<Entities.Product>>
    {
        public class GetAllProductsQueryHandler : IRequestHandler<GetAllProductsQuery, IEnumerable<Entities.Product>>
        {
            ...
            public async Task<IEnumerable<Entities.Product>> Handle(GetAllProductsQuery query, CancellationToken cancellationToken)
            {
